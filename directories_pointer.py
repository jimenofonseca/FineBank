...
def directories():
    ...
    DIRECTORY_LIABILITIES = os.path.join(dir_path, "INPUTS", "LIABILITIES/")
    DATA_PROCESSED_LIABILITIES = os.path.join(DIRECTORY_PROCESSED, "registry_liabilities.csv")
    DATA_PROCESSED_LIABILITIES_METADATA = os.path.join(DIRECTORY_PROCESSED, "registry_liabilities_metadata.csv")
    ...
    directories = {"DIRECTORY_DBS": DIRECTORY_DBS,
                   ...
                   "DIRECTORY_LIABILITIES": DIRECTORY_LIABILITIES,
                   ...
                   "DATA_PROCESSED_LIABILITIES":DATA_PROCESSED_LIABILITIES,
                   "DATA_PROCESSED_LIABILITIES_METADATA":DATA_PROCESSED_LIABILITIES_METADATA,
